<?php
    ...
    $obj_kegiatan = new kategori_bimbingan();
...
<script type="text/javascript" src="js/form_validasi_katbim.js"></script>
<form class="form-horizontal" method="POST" name="form_katbimbingan" action="proses_Katbimbingan.php" >
<fieldset>
  ...
  <!-- Form Name -->
  <legend align="center"><h1>Form Kategori Bimbingan</h1></legend>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="kode">Kode</label>
  <div class="col-md-4">
  <input id="id" name="id" type="number" placeholder="Masukkan Kode" class="form-control input-md" value="<?php echo $data['id']?>">
